...
function T(t, e, n) {
  for (var r, i = t.__k, o = 0; i && o < i.length; o++)
    (r = i[o]) &&
      ((r.__ = t),
      (e = 'function' == typeof r.type ? T(r, e, n) : D(n, r, r, i, r.__e, e)));
  return e;
}
  ...
  try {
    t: if ('function' == typeof x) {
      ...
      (p.state = p.__s),
        ...
        (P = null != c && c.type === S && null == c.key ? c.props.children : c),
  ...
  if (null === d) h === f || (a && t.data === f) || (t.data = f);
    ...
    if (
      ((function (t, e, n, r, i) {
        var o;
        for (o in n)
          'children' === o || 'key' === o || o in e || L(t, o, null, n[o], r);
        for (o in e)
    ...
    return (
      ...
      (o.populatePlugins = function (t, e) {
        for (var r, i = a(e); !(r = i()).done; ) {
          ...
          void 0 !== o.plugin &&
            t.plugin.add(
              n({ id: o.id, props: {} }, o.plugin, { position: ot.Cell }),
            );
        }
      }),
        ...
        return this.props.children
          ...
          : b(
              ...
              this.props.row.cells.map(function (e, n) {
                ...
                return r && r.hidden
                  ? null
                  : b(Vt, { key: e.id, cell: e, row: t.props.row, column: r });
              }),
            );
      }),
      (n.render = function () {
      ...
      (i.render = function () {
        ...
        return (
          ...
          b(
            ...
            b('div', { className: rt('th', 'content') }, this.content()),
            this.isSortable() &&
              b(
                Qt,
                n(
            ...
            this.isResizable() &&
              ...
              b(te, { column: this.props.column, thRef: this.thRef }),
          )
        );
      }),
      e
  ...
  se = /*#__PURE__*/ (function (t) {
    function e(e, n) {
      ...
      return (
        ...
        (r.state = { status: Lt.Loading, header: e.header, data: null }),
        r
      );
    }
    r(e, t);
          ...
          b(
            'div',
            {
              ...
              className: it(
                'gridjs',
                rt('container'),
                this.state.status === Lt.Loading ? rt('loading') : null,
  ...
  ae = /*#__PURE__*/ (function (t) {
    function e(e) {
      ...
      return (
        ...
        (n.plugin = void 0),
        (n.config = new jt({ instance: o(n), eventEmitter: o(n) }).update(e)),
